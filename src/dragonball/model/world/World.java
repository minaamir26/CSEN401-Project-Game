...
public class World implements CellListener, Serializable {
	...
	public void moveUp() throws NotEnoughKiException {
		moveTo(playerRow - 1, playerColumn);
	}

	public void moveDown() throws NotEnoughKiException {
		moveTo(playerRow + 1, playerColumn);
	}

	public void moveLeft() throws NotEnoughKiException {
		moveTo(playerRow, playerColumn - 1);
	}

	public void moveRight() throws NotEnoughKiException {
		moveTo(playerRow, playerColumn + 1);
	}

	private void moveTo(int row, int column) throws NotEnoughKiException {
	...
	public void notifyOnFoeEncountered(NonPlayableFighter foe) throws NotEnoughKiException {
		if (listener != null) {
