...
public class DragonWish extends EventObject {
	...
	public String toString(){
		switch(type){
		case SENZU_BEANS : return senzuBeans+ " Senzu Beans";
		case ABILITY_POINTS : return abilityPoints+ " Ability Points";
		case SUPER_ATTACK : return (superAttack.getName());
		case ULTIMATE_ATTACK : return (ultimateAttack.getName());
		}
		return null;
